...
class Agent:
    ...
    def get_state(self, game):
        ...
        # ecplain also on paper on sheet 2 (page 4)
...
def train():
    ...
    try:
        ...
        record = 0  # set record to 0 if the file is not found
    ...
    while True:
        ...
        if(done):
            # train long memory (replay memory) (experienced memory) trains again on all the previous done moves... it tremendously helps the agent
            # plot result
            game.reset()
            agent.n_games += 1
